                ...
                >
                    ...
                    <div className="px-6 py-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-600 dark:text-slate-400 text-sm">
                                This user will not be able to log in to the system until unblocked.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700 flex gap-3 justify-end">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="px-4 py-2 bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 text-white rounded-xl transition-colors font-medium text-sm flex items-center gap-2"
                        >
                            {loading && (
